...
const ALLOWED_USER_ID = process.env.ALLOWED_USER_ID; // .env dosyasından kullanıcı ID'si
...
discordClient.login(process.env.DISCORD_BOT_TOKEN); // .env dosyasından token